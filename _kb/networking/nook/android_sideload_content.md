...
6. Tap *Allow* in the *Allow B&N NOOK to access files in (DIRECTORY NAME)?* (Where DIRECTORY NAME is whatever you named the folder you may have created.)
7. If you didn't have any EPUB content in the directory you choose or created, you will see *You haven't copied any files to the device yet.* in the content list section
8. After moving content into the directory, navigate to the B&N NOOK app and it may auto-refresh and show the ebooks. If this doesn't happen, swipe down in the center of the screen to initiate a manual refresh. Your content should appear.